...
//QUERY1
$usuario_existente = "SELECT * FROM registro_recepccion WHERE usuario = '$usuario'";
//EJECUTA LA QUERY1
...
//QUERY2
#FGFFF
	$registro ="INSERT INTO registro_recepccion(nombre,apaterno,amaterno,usuario,turno,contraseña,confirmacion) VALUES
