...
?>
    ...
    <div class="comentario">
      ...
      <button class="Botones2" onclick="location.href='eliminacion.php'">
          Eliminar
      </button>
      <button class="Botones2" onclick="location.href='edicion.php'">
          Editar
      </button>
      ...
      <button class="Botones2" onclick="location.href='logout.php'">
          Salir
      </button>
    </div>
    </div>
