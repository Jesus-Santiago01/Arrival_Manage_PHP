...
?>
    ...
    <div class="comentario">
      ...
      <button class="Botones" onclick="location.href='edicion.php'">
          Editar
      </button>
      <button class="Botones" style="rigth:20px;" onclick="location.href='agregacion.php'">
          Agregar
      </button>
