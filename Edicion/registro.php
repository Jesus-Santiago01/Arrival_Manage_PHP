...
//QUERY1
$usuario_existente = "SELECT * FROM registro_edicion WHERE usuario = '$usuario'";
//EJECUTA LA QUERY1
...
//QUERY2
	$registro ="INSERT INTO registro_edicion(nombre,apaterno,amaterno,usuario,turno,contraseña,confirmacion) VALUES
