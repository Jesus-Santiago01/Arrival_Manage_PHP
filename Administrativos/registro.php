...
//QUERY1
$usuario_existente = "SELECT * FROM registro_externos WHERE usuario = '$usuario'";
//EJECUTA LA QUERY1
...
//QUERY2
#FGFFF
	$registro ="INSERT INTO registro_externos(nombre,apaterno,amaterno,usuario,contraseña,confirmacion) VALUES
	('$nombre','$apaterno','$amaterno','$usuario','$contraseña','$confirmacion')";
//EJECUTA LA QUERY2
