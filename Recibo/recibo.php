...
<div class="limite">
    ...
    <?php foreach ($link->query("SELECT * from seller WHERE estatus='aceptado' AND cortina>0 AND documento!='' AND tipo='r1' ORDER BY cortina_hora") as $row){ // aca puedes hacer la consulta e iterarla con each.      ?>
      <tr>
